...
export function AppHeader({
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-parchment-border bg-parchment-light/85 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/notes"
            className="text-sm font-semibold text-ink transition hover:text-brand-800"
          >
            🗒 Notes
          </Link>
        </div>
